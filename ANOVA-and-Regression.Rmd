...
output:
  ...
  pdf_document:
    toc: TRUE
# Custom filename. Idea from https://community.rstudio.com/t/rmarkdown-html-url-name-different-from-rscript-name/1578/3
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), "docs",  "index")) })
---
